    ...
    function drawProfileInfo($session, $db) { //Possivelmente tirar $db das vars pois n sei se nao sera um risco de segurança
        ...
        echo '<div class="profile">';
            ...
            echo '<div class="profile-info">';
                ...
                echo '<h2 id="profile_username">Username: ' . $session->getUsername() . '<img class="edit_button" id="edit_username_button" src="/../images/edit_button.png" alt="edit_button.png" title="Change Name">' . '<img class="confirm_button" id="confirm_username_button" src="/../images/check_button.png" alt="check_button.png" title="Confirm Username Change">' . '</h2>';
